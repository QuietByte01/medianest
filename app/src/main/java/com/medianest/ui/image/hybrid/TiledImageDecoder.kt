 ...
 * Handles tile caching via memory-bounded LruCache, async decoding, and downsampling (inSampleSize) based on zoom.
 */
class TiledImageDecoder(
    ...
    // Allocate up to 1/8th of available max memory for tile cache to prevent OOM
